...
async def serve(q: Q):
    if q.args.show_inputs:
        q.page['example'].items = [
            ...
            ui.text(f'textbox_type_number={q.args.textbox_type_number}'),
            ui.text(f'textbox_type_tel={q.args.textbox_type_tel}'),
        ...
        q.page['example'] = ui.form_card(box='1 1 -1 -1', items=[
            ...
            ui.textbox(name='textbox_type_number', label='With type number', type='numeric', spellcheck=False),
            ui.textbox(name='textbox_type_tel', label='With type tel', type='tel', spellcheck=False),
